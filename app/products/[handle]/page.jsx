...
// export default function Example({ single_product: singleProduct }) {
...
//     const { data } = await fetchShopifyAPI(gql`{
//         products(first:6){
//             edges{
//                 node{
//                     handle
...
//     const { data } = await fetchShopifyAPI(SingleProductByHandle, { handle: params.handle })
//     return {
//         props: {
//             single_product: data.SingleProductByHandle
//         }
//     }
// }

// const SingleProductByHandle = gql`
